...
public class Richiestatratta {
	 ...
	 * @param arrivo
	 */
	public Richiestatratta(String partenza, String arrivo) {
	...
	public String toString() {
		return "Richiestatratta [partenza=" + partenza + ", arrivo=" + arrivo + "]";
	}
	/* (non-Javadoc)
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Richiestatratta other = (Richiestatratta) obj;
		if (arrivo == null) {
